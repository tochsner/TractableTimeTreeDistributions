...
function plot_get_data_likelihood(distributions, tree_file)
    ...
    plot(size = (500, 400), xticks = false, xticklabels = false, legend = :outerbottom)
    bar!((1:n)', data_likelihoods', label = permutedims(readable_name.(distributions)), color = palette[1:n]')
...
distributions = [
    ...
    TractableTimeTreeDist{CCD1,LastDivergenceBranchDist{IndependentDist{LogNormal},IndependentDist{Gamma}}},
]
